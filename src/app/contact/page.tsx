...
export default function ContactPage() {
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground font-sans bg-grid-gray-700/[0.2]">
      <header className="bg-background/80 backdrop-blur-lg sticky top-0 z-50 border-b">
        <nav className="container mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-lg">
            ...
            <Link className="text-muted-foreground hover:text-foreground transition-colors duration-300" href="/about">About</Link>
            <Link className="text-foreground font-semibold" href="/contact">Contact</Link>
          </div>
           ...
           <Sheet>
              ...
              <SheetContent side="left" className="bg-card">
                <nav className="flex flex-col gap-6 mt-8">
                  ...
                  <Link className="text-lg font-medium text-foreground" href="/contact">Contact</Link>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="text-center md:text-left space-y-6">
            ...
            <div className="flex justify-center md:justify-start items-center gap-6 pt-8">
              <Link href="#" className="text-muted-foreground hover:text-primary transition-transform duration-300 transform hover:scale-110">
          ...
          <div className="bg-card p-8 rounded-xl shadow-lg">
            <form>
              ...
              <div className="mb-6">
                <label className="block text-muted-foreground text-sm font-medium mb-2" htmlFor="subject">Subject</label>
                <Input id="subject" name="subject" placeholder="I have the high ground" type="text" />
              </div>
              <div className="mb-6">
                <label className="block text-muted-foreground text-sm font-medium mb-2" htmlFor="message">Message</label>
