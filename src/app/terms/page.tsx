  ...
  return (
    <div className="bg-background text-foreground font-sans">
      <div className="relative flex size-full min-h-screen flex-col overflow-x-hidden">
        <header className="sticky top-0 z-50 flex items-center justify-between whitespace-nowrap border-b border-solid border-border bg-background/80 px-10 py-3 backdrop-blur-sm">
          <div className="flex items-center gap-4">
            <div className="w-8 h-8 text-primary">
              <Sparkles className="h-full w-full" />
            </div>
            <h2 className="text-foreground text-xl font-bold">CaptionCraft</h2>
          </div>
          <nav className="hidden md:flex items-center gap-8">
            <Link className="text-foreground hover:text-primary transition-colors text-sm font-medium" href="/">Features</Link>
            <Link className="text-foreground hover:text-primary transition-colors text-sm font-medium" href="/about">About</Link>
            <Link className="text-foreground hover:text-primary transition-colors text-sm font-medium" href="/contact">Support</Link>
          </nav>
          <Button>
            Get Started
          </Button>
        ...
        <main className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h1 className="text-3xl font-bold mb-4 mt-2 text-4xl sm:text-5xl">Terms of Service</h1>
